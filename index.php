	...
	<div class="jumbotron" id="topContainer">
		<div class="row">
			<div class="col-md-6 col-md-offset-3" id="topRow">
				<h1>Welcome to Web Professional</h1>
			...
			<div class="col-md-4">
				<div class="connect">
					...
					<p>Keep up to date on my posts by connecting with me on the social media of your choice:
						<ul>
							<li><a href="https://ca.linkedin.com/in/marietta-mnatsakanian-371a3b21"><img src="images/linkedin.jpg"></a>
							<li><a href="https://twitter.com/MariettaMnats"><img src="images/twitter.png"></a></li>
							<li><a href="https://plus.google.com/103177514776558866212"><img src="images/googleplus.png"></a></li>
						</ul>
				</div>
			</div>
